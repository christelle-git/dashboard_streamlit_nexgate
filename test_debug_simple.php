<?php
// Test simple pour vérifier les sessions du 07/09
header('Content-Type: text/plain; charset=utf-8');

echo "=== TEST SIMPLE SESSIONS 07/09 ===\n\n";
...
foreach ($events_07_09 as $event) {
    ...
    if (isset($event['click_count']) && $event['click_count'] !== null) {
        $sessions[$sessionId]['click_count'] = max($sessions[$sessionId]['click_count'], $event['click_count']);
    }
    if (isset($event['session_duration']) && $event['session_duration'] !== null) {
