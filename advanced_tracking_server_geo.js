class ServerGeoTracker {
    ...
    trackSessionStart() {
        const sessionData = {
            ...
            // Pas de géolocalisation côté client - le serveur s'en charge
        };
        ...
        try {
            ...
            const response = await fetch(this.apiEndpoint, {
                ...
                headers: {
                    ...
                    'X-Tracker-Agent': 'ServerGeoTracker/1.0'
                },
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        window.serverGeoTracker = new ServerGeoTracker();
    });
} else {
    window.serverGeoTracker = new ServerGeoTracker();
} 